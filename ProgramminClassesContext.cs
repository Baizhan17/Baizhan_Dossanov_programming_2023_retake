...
public partial class ProgramminClassesContext : DbContext
{
    public ProgramminClassesContext()
    {
    }

    public ProgramminClassesContext(DbContextOptions<ProgramminClassesContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=tcp:testsqlservermj.database.windows.net,1433;Initial Catalog=ProgramminClasses;Persist Security Info=False;User ID=dbadmin;Password=Qwer!234;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECA1320944E");
